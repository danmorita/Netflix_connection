<%-- 
    Document   : index
    Created on : 22/05/2017, 16:55:55
    Author     : danmo
--%>
	...
	<body>
		...
		<div class="linha header">
			<ul>
				...
				<li ><a href="" class="botao login">Sign In</a></li>
			</ul>
		</div>
		<!---->
		<!--topo -->
		<div class="linha topo">
			...
			<a href="" class="botao meio">JOIN FREE FOR A MONTH</a>
						...
						<div  class="item" id="cancele">
							...
							<div class="menu-item active" >
								<div class="grande">
									...
									<p><b> Cancel online at anytime</b></p>
								</div>
								<div class ="pequena">
									<p><b> Cancelar</b></p>
								</div>
		...
		<div class="linha conteudo menu">
			...
			<div class="conteudo2" id="1">
					<div class="metade">
						...
						<a href="" class="botao maior">JOIN FREE FOR A MONTH</a>
			...
			<div class="conteudo3" id="2">
				<div class="linha">
					...
					<div >
					<a  href="" class="botao maior direita">JOIN FREE FOR A MONTH</a>
					</div>
				</div>
		...
		<!--Terceira div do menu -->
			<div class= "conteudo3" id="3">
				<div class="flutuante">
					<p><b>Choose one plan and watch everything on Netflix.</b></p>
					<a href="" class="botao maior central">JOIN FREE FOR A MONTH</a>
				...
				<table class="tabela" >
				  ...
				  <tr class= "titulo2">
				  	<td colspan="3" >
				 	 Monthly price after free month ends on 5/11/17
				 	 </td>
				  </tr>
				  <tr>
				    <td class= "titulo" >Monthly price after free month ends on 5/11/17</td>
				    <td>R$19,90</td>		
				    <td>R$22,90</td>
				    <td>R$29,90</td>
				  </tr>
				  ...
				  <tr>
				   <td class= "titulo" >HD available</td>
				    <td class="uncheck"></td>
				    <td class="check"></td>
				    <td class="check"></td>
				  </tr>
				  ...
				  <tr>
				   <td class= "titulo" >Ultra HD available </td>
				    <td class="uncheck"></td>
				    <td class="uncheck"></td>
				    <td class="check"></td>
				  </tr>
				  ...
				  <tr>
				    <td class= "titulo" >Screens you can watch on at the same time</td>
				  ...
				  <tr>
				    <td class= "titulo" >Watch on your laptop, TV, phone and tablet</td>
				    <td class="check"></td>
				    <td class="check"></td>
				    <td class="check"></td>
				  </tr>
				  ...
				  <tr>
				    <td class= "titulo" >Unlimited movies and TV shows</td>
				    <td class="check" ></td>
				    <td class="check"></td>
				    <td class="check"></td>
				  </tr>
				  <tr class= "titulo2">
				   ...
				   <tr>
				    <td class= "titulo" >Cancel anytime</td>
				    <td class="check"></td>
				    <td class="check"></td>
				    <td class="check"></td>
				  </tr>
				  <tr class= "titulo2">
				   ...
				   <tr>
				    <td class= "titulo" >First month free</td>
				    <td class="check"></td>
				    <td class="check"></td>
				    <td class="check"></td>
				  </tr>
		...
		<div class="rodape">
			...
			<ul>
				<p>Questions? Call <a href="">0800-887-0201</a></p>
				<li><a href="">FAQ</a></li>
